	...
	(this, function (root, Backbone, _, $) {
		...
		var g = function () {
			...
			a.bezier = {
				...
				getCurveControlPoints: function (a) {
					...
					e = a.length - 1;
					if (1 == e)
						return c[0] = q((2 * a[0].x + a[1].x) / 3, (2 * a[0].y + a[1].y) / 3), d[0] = q(2 * c[0].x - a[0].x, 2 * c[0].y - a[0].y), [c, d];
					var f = [];
					for (b = 1; b < e - 1; b++)
					...
					for (b = 0; b < e; b++)
						c.push(q(g[b], h[b])), b < e - 1 ? d.push(q(2 * a[b + 1].x - g[b + 1], 2 * a[b + 1].y - h[b + 1])) : d.push(q((a[e].x + g[e - 1]) / 2, (a[e].y + h[e - 1]) / 2));
					return [c, d]
				},
				...
				getFirstControlPoints: function (a) {
					...
					c[0] = a[0] / e;
					for (var f = 1; f < b; f++)
						d[f] = 1 / e, e = (f < b - 1 ? 4 : 3.5) - d[f], c[f] = (a[f] - c[f - 1]) / e;
					for (f = 1; f < b; f++)
						c[b - f - 1] -= d[b - f] * c[b - f];
					return c
				},
			...
			a.Ellipse.fromRect = function (a) {
				return a = r(a),
				o(a.center(), a.width / 2, a.height / 2)
			},
			a.Ellipse.prototype = {
				bbox: function () {
				...
				tangentTheta: function (b) {
					...
					m = f > j.x + h / 2,
					n = f < j.x - h / 2;
					return m || n ? (c = f > j.x ? g - e : g + e, d = h * h / (f - k) - h * h * (g - l) * (c - l) / (i * i * (f - k)) + k) : (d = g > j.y ? f + e : f - e, c = i * i / (g - l) - i * i * (f - k) * (d - k) / (h * h * (g - l)) + l),
					a.point(d, c).theta(b)
				},
				equals: function (a) {
					return a = o(a),
				...
				intersectionWithLineFromCenterToPoint: function (a, b) {
					a = q(a),
					b && a.rotate(q(this.x, this.y), b);
					var c,
					d = a.x - this.x,
					e = a.y - this.y;
					if (0 === d)
						return c = this.bbox().pointNearestToPoint(a), b ? c.rotate(q(this.x, this.y), -b) : c;
					var g = e / d,
					h = g * g,
					i = this.a * this.a,
					j = this.b * this.b,
					...
					k = d < 0 ? -k : k;
					var l = g * k;
					return c = q(this.x + k, this.y + l),
					b ? c.rotate(q(this.x, this.y), -b) : c
				},
				toString: function () {
				...
				intersect: function (a) {
					...
					if (a instanceof r) {
						...
						for (i = 0; i < k.length; i++)
							h = this.intersect(k[i]), null !== h && m.indexOf(h.toString()) < 0 && (l.push(h), m.push(h.toString()));
			...
			a.Point.fromPolar = function (a, b, f) {
				...
				h = c(a * e(b)),
				i = s(u(b));
				return i < 90 ? h = -h : i < 180 ? (g = -g, h = -h) : i < 270 && (g = -g),
				q(f.x + g, f.y + h)
			},
			...
			a.Point.prototype = {
				...
				difference: function (a, b) {
					return Object(a) === a && (b = a.y, a = a.x),
					q(this.x - (a || 0), this.y - (b || 0))
				},
				distance: function (a) {
				...
				round: function (a) {
					var b = n(10, a || 0);
					return this.x = j(this.x * b) / b,
					this.y = j(this.y * b) / b,
					this
				},
				scale: function (a, b, c) {
					return c = c && q(c) || q(0, 0),
			...
			a.Rect.prototype = {
				...
				intersectionWithLineFromCenterToPoint: function (a, b) {
					a = q(a);
					var c,
					d = q(this.x + this.width / 2, this.y + this.height / 2);
					b && a.rotate(d, b);
				...
				round: function (a) {
					...
					return this.x = j(this.x * b) / b,
					this.y = j(this.y * b) / b,
					this.width = j(this.width * b) / b,
					this.height = j(this.height * b) / b,
					this
				},
				scale: function (a, b, c) {
				...
				maxRectScaleToFit: function (b, c) {
					...
					d = e = f = g = h = i = j = k = 1 / 0;
					var n = b.origin();
					n.x < l && (d = (this.x - l) / (n.x - l)),
					n.y < m && (h = (this.y - m) / (n.y - m));
					var o = b.corner();
					o.x > l && (e = (this.x + this.width - l) / (o.x - l)),
					o.y > m && (i = (this.y + this.height - m) / (o.y - m));
					var p = b.topRight();
					p.x > l && (f = (this.x + this.width - l) / (p.x - l)),
					p.y < m && (j = (this.y - m) / (p.y - m));
					var q = b.bottomLeft();
					return q.x < l && (g = (this.x - l) / (q.x - l)),
					q.y > m && (k = (this.y + this.height - m) / (q.y - m)), {
						sx: Math.min(d, e, f, g),
						sy: Math.min(h, i, j, k)
					}
				},
		...
		V = Vectorizer = function () {
			...
			d.prototype.getTransformToElement = function (a) {
				return a = d.toNode(a),
				a.getScreenCTM().inverse().multiply(this.node.getScreenCTM())
			},
			d.prototype.transform = function (a, b) {
				var c = this.node;
				if (d.isUndefined(a))
					return d.transformStringToMatrix(this.attr("transform"));
				if (b && b.absolute)
					return this.attr("transform", d.matrixToTransformString(a));
				var e = d.createSVGTransform(a);
				return c.transform.baseVal.appendItem(e),
				this
			},
			...
			d.prototype.text = function (a, b) {
				...
				f = this.attr("y");
				f || this.attr("y", "0.8em"),
				a ? this.removeAttr("display") : this.attr("display", "none"),
						...
						if (b.annotations) {
							for (var r = 0, s = d.annotateString(e[o], d.isArray(b.annotations) ? b.annotations : [b.annotations], {
								...
								if (d.isObject(u)) {
									...
									v && v > r && (r = v),
									c = d("tspan", u.attrs),
									b.includeAnnotationIndices && c.attr("annotations", u.annotations),
									u.attrs.class && c.addClass(u.attrs.class),
									c.node.textContent = u.t
								} else
							...
							q.node.textContent = p;
					else
						q.addClass("v-empty-line"), q.node.style.fillOpacity = 0, q.node.style.strokeOpacity = 0, q.node.textContent = "-";
					d(g).append(q),
					l += p.length + 1
				}
				return this
			...
			d.prototype.appendTo = function (a) {
				return d.toNode(a).appendChild(this.node),
				this
			},
			...
			d.prototype.findIntersection = function (a, b) {
				...
				if (e.intersectionWithLineFromCenterToPoint(a)) {
					var h,
					i = this.node.localName.toUpperCase();
					if ("RECT" === i) {
						...
						s,
						t,
						u = "PATH" === i ? this : this.convertToPath(),
						v = u.sample(),
						w = 1 / 0,
						x = [];
						for (o = 0; o < v.length; o++)
							p = v[o], q = d.createSVGPoint(p.x, p.y), q = q.matrixTransform(this.getTransformToElement(b)), p = g.point(q), r = p.distance(f), s = 1.1 * p.distance(a), t = r + s, t < w ? (w = t, x = [{
										sample: p,
										refDistance: s
									}
								]) : t < w + 1 && x.push({
			...
			d.transformRegex = /(\w+)\(([^,)]+),?([^)]+)?\)/gi,
			d.transformSeparatorRegex = /[ ,]+/,
			d.transformationListRegex = /^(\w+)\((.*)\)/,
			d.transformStringToMatrix = function (a) {
				...
				for (var e = 0, f = c.length; e < f; e++) {
					...
					if (h) {
						...
						case "scale":
							i = parseFloat(o[0]),
							j = void 0 === o[1] ? i : parseFloat(o[1]),
							n = n.scaleNonUniform(i, j);
							break;
						case "translate":
							k = parseFloat(o[0]),
							l = parseFloat(o[1]),
						...
						case "rotate":
							...
							k = parseFloat(o[1]) || 0,
							l = parseFloat(o[2]) || 0,
							n = 0 !== k || 0 !== l ? n.translate(k, l).rotate(m).translate(-k, -l) : n.rotate(m);
							break;
						case "skewx":
							m = parseFloat(o[0]),
							n = n.skewX(m);
			...
			d.matrixToTransformString = function (a) {
				return a || (a = !0),
				"matrix(" + (a.a || 1) + "," + (a.b || 0) + "," + (a.c || 0) + "," + (a.d || 1) + "," + (a.e || 0) + "," + (a.f || 0) + ")"
			},
			d.parseTransformString = function (a) {
				...
				if (a) {
					...
					if (a.trim().indexOf("matrix") >= 0) {
						...
						b = [h.translateX, h.translateY],
						e = [h.scaleX, h.scaleY],
						c = [h.rotation];
						var i = [];
						0 === b[0] && 0 === b[0] || i.push("translate(" + b + ")"),
						1 === e[0] && 1 === e[1] || i.push("scale(" + e + ")"),
						0 !== c[0] && i.push("rotate(" + c + ")"),
						a = i.join(" ")
					} else {
			...
			d.annotateString = function (a, b, c) {
				...
				for (var e, f, g, h = c.offset || 0, i = [], j = [], k = 0; k < a.length; k++) {
					...
					g = j[k - 1],
					g ? d.isObject(f) && d.isObject(g) ? JSON.stringify(f.attrs) === JSON.stringify(g.attrs) ? e.t += f.t : (i.push(e), e = f) : d.isObject(f) ? (i.push(e), e = f) : d.isObject(g) ? (i.push(e), e = f) : e = (e || "") + f : e = f
				}
				return e && i.push(e),
				i
			},
			...
			d.rectToPath = function (a) {
				...
				return b = g || h || i || j ? ["M", c, d + i, "v", f - i - j, "a", h, j, 0, 0, 0, h, j, "h", e - 2 * h, "a", h, j, 0, 0, 0, h, -j, "v",  - (f - j - i), "a", g, i, 0, 0, 0, -g, -i, "h",  - (e - 2 * g), "a", g, i, 0, 0, 0, -g, i, "Z"] : ["M", c, d, "H", c + e, "V", d + f, "H", c, "V", d, "Z"],
				b.join(" ")
			},
			d.toNode = function (a) {
		...
		var joint = {
			...
			env: {
				...
				_tests: {
					svgforeignobject: function () {
						return !!document.createElementNS && /SVGForeignObject/.test({}
							.toString.call(document.createElementNS("http://www.w3.org/2000/svg", "foreignObject")))
					}
				},
			...
			util: {
				...
				setByPath: function (a, b, c, d) {
					for (var e = _.isArray(b) ? b : b.split(d || "/"), f = a, g = 0, h = e.length; g < h - 1; g++)
						f = f[e[g]] || (f[e[g]] = {});
					return f[e[h - 1]] = c,
					a
				},
				...
				shapePerimeterConnectionPoint: function (a, b, c, d) {
					...
					return c ? (f = V(c).findIntersection(d, a.paper.viewport), f || (e = g.rect(V(c).bbox(!1, a.paper.viewport)))) : (e = b.model.getBBox(), f = e.intersectionWithLineFromCenterToPoint(d)),
					f || e.center()
				},
				...
				breakText: function (a, b, c, d) {
					...
					for (var k, l, m = a.split(" "), n = [], o = [], p = 0, q = 0, r = m.length; p < r; p++) {
						var s = m[p];
						if (j.data = o[q] ? o[q] + " " + s : s, i.getComputedTextLength() <= e)
							o[q] = j.data, k && (n[q++] = !0, k = 0);
						else {
							if (!o[q] || k) {
								var t = !!k;
								if (k = s.length - 1, t || !k) {
									...
									m[p] = s.substring(0, k),
									m[p + 1] = s.substring(k) + m[p + 1]
								} else
									m.splice(p, 1, s.substring(0, k), s.substring(k)), r++, q && !n[q - 1] && q--;
								p--;
								continue
							}
							q++,
				...
				setAttributesBySelector: function (a, b) {
					...
					_.each(b, function (a, b) {
						...
						_.has(a, "class") && (d.addClass(a.class), a = _.omit(a, "class")),
						d.attr(a)
					})
				},
				...
				format: {
					...
					prefix: function (a, b) {
						...
						d = 0;
						return a && (a < 0 && (a *= -1), b && (a = this.round(a, this.precision(a, b))), d = 1 + Math.floor(1e-12 + Math.log(a) / Math.LN10), d = Math.max(-24, Math.min(24, 3 * Math.floor((d <= 0 ? d + 1 : d - 1) / 3)))),
						c[8 + d / 3]
					}
				},
				template: function (a) {
				...
				toggleFullScreen: function (a) {
					...
					a = a || document.body,
					b(document, "FullscreenElement") || b(document, "FullScreenElement") ? b(document, "ExitFullscreen") || b(document, "CancelFullScreen") : b(a, "RequestFullscreen") || b(a, "RequestFullScreen")
				},
				...
				wrappers: {
					cells: function (a) {
						return function () {
							...
							return _.isArray(c) || (d instanceof joint.dia.Cell ? c = b : c instanceof joint.dia.Cell && (c = b.length > 1 ? _.initial(b) : b)),
							d instanceof joint.dia.Cell && (d = {}),
							a.call(this, c, d)
						}
					}
				}
		...
		joint.mvc.View = Backbone.View.extend({
				...
				setTheme: function (a, b) {
					return b = b || {},
					this.theme && this.requireSetThemeOverride && !b.override ? this : (this.removeThemeClassName(), this.addThemeClassName(a), this.onSetTheme(this.theme, a), this.theme = a, this)
				},
		...
		joint.dia.Graph = Backbone.Model.extend({
				...
				set: function (a, b, c) {
					var d;
					return "object" == typeof a ? (d = a, c = b) : (d = {})[a] = b,
					d.hasOwnProperty("cells") && (this.resetCells(d.cells, c), d = _.omit(d, "cells")),
				...
				clear: function (a) {
					...
					do
						c.shift().remove(a);
					while (c.length > 0);
					return this.stopBatch("clear"),
					this
				},
				_prepareCell: function (a, b) {
					var c;
					if (a instanceof Backbone.Model ? (c = a.attributes, a.graph || b && b.dry || (a.graph = this)) : c = a, !_.isString(c.type))
				...
				addCells: function (a, b) {
					return a.length && (a = _.flattenDeep(a), b.position = a.length, this.startBatch("add"), _.each(a, function (a) {
							b.position--,
							this.addCell(a, b)
						}, this), this.stopBatch("add")),
					this
				},
				resetCells: function (a, b) {
					var c = _.map(a, _.bind(this._prepareCell, this, _, b));
					return this.get("cells").reset(c, b),
					this
				},
				removeCells: function (a, b) {
					return a.length && (this.startBatch("remove"), _.invoke(a, "remove", b), this.stopBatch("remove")),
					this
				},
		...
		function (a, b, c, d) {
			...
			i["ref-dy"] = i.refDy,
			i["ref-dx"] = i.refDx,
			i["ref-width"] = i.refWidth,
			i["ref-height"] = i.refHeight,
			i["x-alignment"] = i.xAlignment,
			i["y-alignment"] = i.yAlignment
		}
		(joint, _, g, $),
		joint.dia.Cell = Backbone.Model.extend({
				...
				prop: function (a, b, c) {
					...
					if (e || _.isArray(a)) {
						if (arguments.length > 1) {
							...
							var h = g[0],
							i = g.length;
							if (c = c || {}, c.propertyPath = f, c.propertyValue = b, c.propertyPathArray = g, 1 === i)
								return this.set(h, b, c);
				...
				transition: function (a, b, c, d) {
					...
					h = _.bind(function (b) {
							...
							b -= g,
							e = b / c.duration,
							e < 1 ? this._transitionIds[a] = d = joint.util.nextFrame(h) : (e = 1, delete this._transitionIds[a]),
				...
				define: function (a, b, c, d) {
					...
					return joint.util.setByPath(joint.shapes, a, e, "."),
					e
				}
			}),
		joint.dia.CellView = joint.mvc.View.extend({
				...
				getStrokeBBox: function (a) {
					...
					a = a || this.el;
					var c,
					d = V(a).bbox(!1, this.paper.viewport);
				...
				processNodeAttributes: function (a, b) {
					...
					l = [];
					for (c in b)
						b.hasOwnProperty(c) && (d = b[c], e = this.getAttributeDefinition(c), !e || _.isFunction(e.qualify) && !e.qualify.call(this, d, a, b) ? (h || (h = {}), h[joint.util.toKebabCase(c)] = d) : (_.isString(e.set) && (h || (h = {}), h[e.set] = d), null !== d && l.push(c, e)));
					for (f = 0, g = l.length; f < g; f += 2)
						c = l[f], e = l[f + 1], d = b[c], _.isFunction(e.set) && (i || (i = {}), i[c] = d), _.isFunction(e.position) && (j || (j = {}), j[c] = d), _.isFunction(e.offset) && (k || (k = {}), k[c] = d);
					return {
						raw: b,
						normal: h,
						set: i,
				...
				updateRelativeAttributes: function (a, b, c, d) {
					...
					for (e in l)
						f = l[e], h = this.getAttributeDefinition(e), t = h.position.call(this, f, c.clone(), a, i), t && q.offset(g.Point(t).scale(r, s));
					if (this.setNodeAttributes(a, j), m) {
						var v = a.getBoundingClientRect();
						if (v.width > 0 && v.height > 0) {
							var w = V.transformRect(a.getBBox(), p).scale(1 / r, 1 / s);
							for (e in m)
								f = m[e], h = this.getAttributeDefinition(e), t = h.offset.call(this, f, w, a, i), t && q.offset(g.Point(t).scale(r, s))
						}
					}
					q.round(1),
					p.e = q.x,
					p.f = q.y,
					a.setAttribute("transform", V.matrixToTransformString(p))
				},
				...
				updateDOMSubtreeAttributes: function (a, b, c) {
					...
					for (var p in n)
						if (h = n[p], f = h.attributes, e = h.node, i = this.processNodeAttributes(e, f), i.set || i.position || i.offset) {
							var q,
							r = o[p] && o[p].attributes,
							s = r && void 0 === f.ref ? r.ref : f.ref;
							if (s) {
								if (q = (j[s] || this.findBySelector(s, a))[0], !q)
									throw new Error('dia.ElementView: "' + s + '" reference does not exists.')
							} else
								q = null;
							d = {
								node: e,
							...
							this.setNodeAttributes(e, i.normal);
					for (var u = 0, v = l.length; u < v; u++) {
						...
						x = k[w];
						x || (x = k[w] = q ? V(q).bbox(!1, c.rotatableNode || a) : c.rootBBox),
						m ? (i = this.processNodeAttributes(e, d.allAttributes), this.mergeProcessedAttributes(i, d.processedAttributes)) : i = d.processedAttributes,
						this.updateRelativeAttributes(e, i, x, c)
					}
				},
				mergeProcessedAttributes: function (a, b) {
					...
					a.offset || (a.offset = {}),
					_.extend(a.set, b.set),
					_.extend(a.position, b.position),
					_.extend(a.offset, b.offset);
					var c = a.normal && a.normal.transform;
					void 0 !== c && b.normal && (b.normal.transform = c),
					a.normal = b.normal
				},
				...
				pointerdown: function (a, b, c) {
					this.model.graph && (this.model.startBatch("pointer"), this._graph = this.model.graph),
		...
		joint.dia.Element = joint.dia.Cell.extend({
				...
				translate: function (a, b, c) {
					...
					return c.tx = a,
					c.ty = b,
					c.transition ? (_.isObject(c.transition) || (c.transition = {}), this.transition("position", k, _.extend({}, c.transition, {
		...
		joint.dia.ElementView = joint.dia.CellView.extend({
				...
				resize: function (a, b, c) {
					...
					g = this.scalableNode;
					if (!g)
						return 0 !== f && this.rotate(), void this.update();
					var h = g.bbox(!0);
				...
				mouseenter: function (a) {
					...
					this.notify("element:mouseenter", a)
				},
				mouseleave: function (a) {
					joint.dia.CellView.prototype.mouseleave.apply(this, arguments),
					this.notify("element:mouseleave", a)
				}
			}),
		joint.dia.Link = joint.dia.Cell.extend({
				...
				label: function (a, b, c) {
					return a = a || 0,
					arguments.length <= 1 ? this.prop(["labels", a]) : this.prop(["labels", a], b, c)
				},
				translate: function (a, b, c) {
					return c = c || {},
					c.translateBy = c.translateBy || this.id,
		...
		joint.dia.LinkView = joint.dia.CellView.extend({
				...
				onSourceChange: function (a, b, c) {
					...
					c.translateBy && this.model.get("target").id || (c.updateConnectionOnly = !0, this.update(this.model, null, c))
				},
				onTargetChange: function (a, b, c) {
					this.watchTarget(a, b),
					c.translateBy || (c.updateConnectionOnly = !0, this.update(this.model, null, c))
				},
				onVerticesChange: function (a, b, c) {
					this.renderVertexMarkers(),
					c.translateBy && c.translateBy !== this.model.id || (c.updateConnectionOnly = !0, this.update(a, null, c))
				},
				...
				renderLabels: function () {
					...
					for (var f = joint.util.template(b.get("labelMarkup") || b.labelMarkup), g = V(f()), h = this.can("labelMove"), i = 0; i < e; i++) {
						...
						this.updateDOMSubtreeAttributes(l.node, m)
					}
					return this
				},
				...
				update: function (a, b, c) {
					return c = c || {},
					c.updateConnectionOnly || this.updateDOMSubtreeAttributes(this.el, this.model.attr()),
				...
				_findConnectionPoints: function (a) {
					...
					i.sourcePoint = d || b.clone(),
					i.targetPoint = e || c.clone(),
					this.sourcePoint = b,
					this.targetPoint = c
				},
						...
						_.each(a, function (a, e) {
							...
							if (_.isObject(i))
								...
								for (var k, l, m, n = 1 / 0, o = 0; o < d.length; o++)
									l = d[o], m = g.line(l, j).squaredLength(), m < n && (n = m, k = o);
								var p = d[k - 1],
								q = d[k + 1],
								r = 0;
				...
				onEndModelChange: function (a, b, c) {
					...
					if (b) {
						...
						if (c.handleBy === this.cid && c.translateBy && e.isEmbeddedIn(b) && !_.isEmpty(e.get("vertices")) && (d = !1), !this.updatePostponed && j.id) {
							...
							(c.handleBy === this.cid || c.translateBy && o.isEmbeddedIn(c.translateBy)) && (this.updatePostponed = !0, d = !1)
						}
					} else
				...
				getConnectionPoint: function (a, b, c) {
					...
					if (_.isEmpty(b) && (b = {
						...
						var e,
						f = g.Rect("source" === a ? this.sourceBBox : this.targetBBox);
						if (c.id) {
						...
						if (i.perpendicularLinks || this.options.perpendicular) {
							...
							if (k.y <= e.y && e.y <= l.y)
								...
								d = f.intersectionWithLineFromCenterToPoint(e), d = d || f.center()
				...
				pointerdown: function (a, b, c) {
					if (joint.dia.CellView.prototype.pointerdown.apply(this, arguments), this.notify("link:pointerdown", a, b, c), this._dx = b, this._dy = c, null == a.target.getAttribute("magnet")) {
						var d,
						e = joint.util.removeClassNamePrefix(a.target.getAttribute("class")),
				...
				pointermove: function (a, b, c) {
					...
					case "label-move":
						for (var e, f, h, i, j = {
							...
							h = k[m], i = g.line(h, j).squaredLength(), i < l && (l = i, e = h, f = m);
						var o = k[f - 1],
						p = k[f + 1],
						q = 0;
				...
				pointerup: function (a, b, c) {
					if ("label-move" === this._action)
						...
						n && (h.id && this.notify("link:disconnect", a, e.findViewByModel(h.id), this._initialMagnet, g), m.id && this.notify("link:connect", a, e.findViewByModel(m.id), d, g)),
				...
				mouseenter: function (a) {
					joint.dia.CellView.prototype.mouseenter.apply(this, arguments),
					this.notify("link:mouseenter", a)
				},
				mouseleave: function (a) {
					joint.dia.CellView.prototype.mouseleave.apply(this, arguments),
					this.notify("link:mouseleave", a)
				}
			}, {
		...
		joint.dia.Paper = joint.mvc.View.extend({
				...
				init: function () {
					...
					this.render(),
					this.setDimensions(),
					this.listenTo(a, "add", this.onCellAdded).listenTo(a, "remove", this.removeView).listenTo(a, "reset", this.resetViews).listenTo(a, "sort", this._onSort).listenTo(a, "batch:stop", this._onBatchStop),
				...
				cloneOptions: function () {
					var a = this.options;
					a.origin = _.clone(a.origin),
					a.defaultConnector = _.clone(a.defaultConnector),
					a.highlighting = _.defaultsDeep({}, a.highlighting, this.constructor.prototype.options.highlighting)
				},
				...
				render: function () {
					...
					this.options.background && this.drawBackground(this.options.background),
				...
				matrix: function (a) {
					...
					if (void 0 === a) {
						...
						return (this._viewportTransformString || null) === c ? a = this._viewportMatrix : (a = b.getCTM(), this._viewportMatrix = a, this._viewportTransformString = c),
						V.createSVGMatrix(a)
					}
					return a = V.createSVGMatrix(a),
					V(b).transform(a, {
						absolute: !0
					}),
					this._viewportMatrix = a,
					this._viewportTransformString = b.getAttribute("transform"),
					this
				},
				...
				fitToContent: function (a, b, c, d) {
					...
					j = 0,
					k = 0;
					("negative" == d.allowNewOrigin && e.x < 0 || "positive" == d.allowNewOrigin && e.x >= 0 || "any" == d.allowNewOrigin) && (j = Math.ceil(-e.x / a) * a, j += c.left, h += j),
					("negative" == d.allowNewOrigin && e.y < 0 || "positive" == d.allowNewOrigin && e.y >= 0 || "any" == d.allowNewOrigin) && (k = Math.ceil(-e.y / b) * b, k += c.top, i += k),
					h += c.right,
					i += c.bottom,
					h = Math.max(h, d.minWidth || 0),
					i = Math.max(i, d.minHeight || 0),
					h = Math.min(h, d.maxWidth || Number.MAX_VALUE),
					i = Math.min(i, d.maxHeight || Number.MAX_VALUE);
					var l = h != this.options.width || i != this.options.height,
					m = j != g.tx || k != g.ty;
					m && this.translate(j, k),
					l && this.setDimensions(h, i)
				},
				scaleContentToFit: function (a) {
					...
					if (b.width && b.height) {
						...
						l = Math.min(f, Math.max(e, l)),
						m = Math.min(i, Math.max(h, m)),
						this.scale(l, m);
				...
				createViewForModel: function (a) {
					var b,
					c,
					d = this.options.cellViewNamespace,
					e = a.get("type") + "View",
				...
				removeView: function (a) {
					...
					return b && (b.remove(), delete this._views[a.id]),
					b
				},
				...
				resetViews: function (a, b) {
					...
					this.options.async ? this.asyncRenderViews(c, b) : (_.each(c, this.renderView, this), this.sortViews())
				},
				...
				translate: function (a, b) {
					...
					return e.x = d.tx,
					e.y = d.ty,
					this.trigger("translate", d.tx, d.ty),
					this.options.drawGrid && this.drawGrid(),
					this
				},
				findView: function (a) {
				...
				clearGrid: function () {
					return this.$grid && this.$grid.css("backgroundImage", "none"),
					this
				},
				_getGriRefs: function () {
					return this._gridCache || (this._gridCache = {
							...
							patterns: {},
							add: function (a, b) {
								V(this.root.node.childNodes[0]).append(b),
								this.patterns[a] = b,
				...
				drawGrid: function (a) {
					...
					_.each(this._gridSettings, function (a, f) {
						...
						h.width = b * (d.a || 1) * (h.scaleFactor || 1),
						h.height = b * (d.d || 1) * (h.scaleFactor || 1),
						e.exist(g) || e.add(g, V("pattern", {
								id: g,
					...
					return f = "url(data:image/svg+xml;base64," + btoa(f) + ")",
					this.$grid.css("backgroundImage", f),
					this
				},
				updateBackgroundImage: function (a) {
					...
					_.isObject(c) && (c = g.rect(c).scale(d.sx, d.sy), c = c.width + "px " + c.height + "px"),
					this.$background.css({
						backgroundSize: c,
				...
				drawBackgroundImage: function (a, b) {
					if (!(a instanceof HTMLImageElement))
						return void this.$background.css("backgroundImage", "");
					b = b || {};
					var c,
					d = b.size,
					...
					if (_.isFunction(h)) {
						...
						c = i.toDataURL("image/png"),
						e = "repeat",
						_.isObject(d) ? (d.width *= i.width / a.width, d.height *= i.height / a.height) : _.isUndefined(d) && (b.size = {
								width: i.width / g,
								height: i.height / g
							})
					} else
						c = a.src, _.isUndefined(d) && (b.size = {
								width: a.width,
								height: a.height
							});
					this.$background.css({
				...
				drawBackground: function (a) {
					if (a = a || {}, this.updateBackgroundColor(a.color), a.image) {
						...
						b.onload = _.bind(this.drawBackgroundImage, this, b, a),
						b.src = a.image
					} else
						this.drawBackgroundImage(null), this._background = null;
					return this
				},
				setInteractivity: function (a) {
					this.options.interactive = a,
				...
				defineFilter: function (a) {
					...
					if (b || (b = c + this.svg.id + joint.util.hashCode(JSON.stringify(a))), !this.isDefined(b)) {
						...
						e = d[c] && d[c](a.args || {});
						if (!e)
							throw new Error("Non-existing filter " + c);
						var f = _.extend({
				...
				backgroundPatterns: {
					flipXy: function (a) {
						...
						return e.drawImage(a, 0, 0, c, d),
						e.setTransform(-1, 0, 0, -1, b.width, b.height),
						e.drawImage(a, 0, 0, c, d),
						e.setTransform(-1, 0, 0, 1, b.width, 0),
						e.drawImage(a, 0, 0, c, d),
						e.setTransform(1, 0, 0, -1, 0, b.height),
						e.drawImage(a, 0, 0, c, d),
						b
					},
					flipX: function (a) {
					...
					watermark: function (a, b) {
						...
						for (var f = e.getContext("2d"), h = _.isNumber(b.watermarkAngle) ? -b.watermarkAngle : -20, i = g.toRad(h), j = e.width / 4, k = e.height / 4, l = 0; l < 4; l++)
							for (var m = 0; m < 4; m++)
								(l + m) % 2 > 0 && (f.setTransform(1, 0, 0, 1, (2 * l - 1) * j, (2 * m - 1) * k), f.rotate(i), f.drawImage(a, -c / 2, -d / 2, c, d));
						return e
					}
				},
				gridPatterns: {
					...
					mesh: [{
							...
							update: function (a, b) {
								...
								e = b.height,
								f = b.thickness;
								c = d - f >= 0 && e - f >= 0 ? ["M", d, 0, "H0 M0 0 V0", e].join(" ") : "M 0 0 0 0",
								V(a).attr({
									d: c,
									stroke: b.color,
		...
		function (a, b) {
			var c = function (c) {
				...
				this.ports = [],
				this.groups = {},
				this.portLayoutNamespace = a.layout.Port,
				this.portLabelLayoutNamespace = a.layout.PortLabel,
				this._init(d)
			};
			c.prototype = {
				getPorts: function () {
				...
				_init: function (a) {
					b.transform(a.groups || {}, b.bind(this._evaluateGroup, this), this.groups),
					b.transform(a.items || [], b.bind(this._evaluatePort, this), this.ports)
				},
				...
				_evaluatePort: function (a, c) {
					...
					d.markup = d.markup || e.markup,
					d.attrs = b.merge({}, e.attrs, d.attrs),
					d.position = this._createPositionNode(e, d),
					d.label = b.merge({}, e.label, this._getLabel(d)),
					d.z = this._getZIndex(e, d),
					d.size = b.extend({}, e.size, d.size),
					a.push(d)
				},
			...
			b.extend(a.dia.Element.prototype, {
				...
				portProp: function (a, c, d, e) {
					...
					return b.isArray(c) ? g[0] = ["ports", "items", f].concat(c) : b.isString(c) ? g[0] = ["ports/items/", f, "/", c].join("") : (g = ["ports/items/" + f], b.isPlainObject(c) && (g.push(c), g.push(d))),
				...
				removePort: function (a, c) {
					...
					return f !== -1 && (e.splice(f, 1), d.rewrite = !0, this.prop("ports/items", e, d)),
					this
				},
				_createPortData: function () {
					var a = this._validatePorts();
					if (a.length > 0)
						throw this.set("ports", this.previous("ports")), new Error(a.join(" "));
					var d;
					this._portSettingsData && (d = this._portSettingsData.getPorts()),
					this._portSettingsData = new c(this.get("ports"));
					...
					if (d) {
						...
						g.length > 0 && this.trigger("ports:remove", this, g),
						f.length > 0 && this.trigger("ports:add", this, f)
					}
				}
			}),
			b.extend(a.dia.ElementView.prototype, {
				...
				_updatePortGroup: function (a) {
					for (var b = g.Rect(this.model.size()), c = this.model._portSettingsData.getGroupPortsMetrics(a, b), d = 0, e = c.length; d < e; d++) {
						...
						this.applyPortTransform(i.portElement, j),
						this.updateDOMSubtreeAttributes(i.portElement.node, f.portAttrs, {
		...
		joint.shapes.basic.PortsModelInterface = {
			...
			getPortSelector: function (a) {
				...
				if (c < 0 && (b = ".outPorts", c = this.get("outPorts").indexOf(a), c < 0))
		...
		joint.shapes.basic.TextBlockView = joint.dia.ElementView.extend({
				initialize: function () {
					...
					joint.env.test("svgforeignobject") || this.listenTo(this.model, "change:content change:size", function (a) {
			...
			function l(c, d, f, l) {
				...
				if (c instanceof a.rect ? (m = h(c, l.startDirections, l), o = c.center().snapToGrid(q)) : (o = c.clone().snapToGrid(q), m = [o]), d instanceof a.rect ? (n = h(d, l.endDirections, l), p = d.center().snapToGrid(q)) : (p = d.clone().snapToGrid(q), n = [p]), m = b.filter(m, f.isPointAccessible, f), n = b.filter(n, f.isPointAccessible, f), m.length > 0 && n.length > 0) {
					...
					for (var u, v, w = l.directions, x = w.length, y = l.maximumLoops, z = b.invoke(n, "toString"); !r.isEmpty() && y > 0; ) {
						...
						if (z.indexOf(A) >= 0 && (v = j(E, i(B, p, x)), B.equals(p) || v < 180))
							return l.previousDirAngle = E, g(s, B, o, p);
						for (var F = 0; F < x; F++)
		...
		joint.highlighters.stroke = {
			...
			highlight: function (a, b, c) {
				...
				if (!this._views[d]) {
					var e,
					f = _.defaults(c || {}, this.defaultOptions),
					g = V(b);
					try {
						var h = g.convertToPathData()
					} catch (a) {
						e = g.bbox(!0),
						h = V.rectToPath(_.extend({}, f, e))
					}
					var i = V("path").attr({
							d: h,
							"pointer-events": "none",
					...
					i.transform(a.el.getCTM().inverse()),
					i.transform(b.getCTM());
					var j = f.padding;
					if (j) {
						e || (e = g.bbox(!0));
						var k = e.x + e.width / 2,
					...
					q = a.model;
					o.listenTo(q, "remove", p),
					o.listenTo(q.graph, "reset", p),
					a.vel.append(i)
				}
			},
			unhighlight: function (a, b, c) {
			...
			toGraphLib: function (a, b) {
				...
				return a.get("cells").each(function (a) {
					if (a.isLink()) {
						...
						d.setNode(a.id, e(a)), d.isCompound() && a.has("parent") && d.setParent(a.id, a.get("parent"))
				}),
				d
			}
		},
		...
		joint.shapes.chart.Plot = joint.shapes.basic.Generic.extend({
				...
				legendPosition: function (a, b) {
					...
					_.each([".legend/ref-x", ".legend/ref-y", ".legend/ref-dx", ".legend/ref-dy", ".legend/x-alignment", ".legend/y-alignment"], _.bind(this.removeAttr, this, _, {
							silent: !0
						}));
					var c = b.padding || 10,
					d = {
		...
		joint.shapes.chart.PlotView = joint.dia.ElementView.extend({
				...
				calculateStats: function (a) {
					...
					_.each(a, function (a, g) {
						...
						_.each(a.data, function (f) {
							...
							i && (h.decreasingX = h.decreasingX && f.x < i.x, h.decreasingY = h.decreasingY && f.y < i.y, h.nonDecreasingX = h.nonDecreasingX && f.x >= i.x, h.nonDecreasingY = h.nonDecreasingY && f.y >= i.y),
				...
				seriePathData: function (a, b, c) {
					...
					e,
					f,
					h = _.isUndefined(b.interpolate) ? this.model.get("interpolate") : b.interpolate,
					i = a.length;
					switch (h) {
					case "bezier":
						...
						break;
					case "step":
						for (f = a[0], d = ["M", f.x, f.y], e = 1; e < i; e++)
							d.push("H", (f.x + a[e].x) / 2, "V", a[e].y), f = a[e];
						break;
					case "stepBefore":
						for (d = ["M", a[0].x, a[0].y], e = 1; e < i; e++)
		...
		joint.shapes.chart.PieView = joint.dia.ElementView.extend({
				...
				calculateSeries: function (a) {
					...
					return this._series = _.map(b, function (b, e) {
							...
							return b.data = _.map(b.data, function (a, b) {
									...
									a.outerRadius = i,
									a.innerRadius = i - j,
									e || (a = _.defaults(a, _.pick(d, "offset", "onClickEffect", "onHoverEffect")), a.isOuter = !0, a.offset = a.offset > 1 ? a.offset : a.offset * a.outerRadius, a.onClickEffect.offset = a.onClickEffect.offset > 1 ? a.onClickEffect.offset : a.onClickEffect.offset * a.outerRadius),
									a.serieIndex = e,
									a.sliceIndex = b,
					...
					_.each(a, function (a, e) {
						if (a.showLegend) {
							...
							_.each(a.data, function (a, c) {
								...
								_.isObject(g) ? this.applyGradient(f.findOne("circle"), "fill", g) : f.findOne("circle").attr({
									fill: g
								}),
								V(this.elLegendItems).append(f)
							}, this)
				...
				updateSlice: function (a) {
					...
					a.isOuter && (b.addClass("outer"), a.offset && (b.addClass("clicked"), this.effectOnSlice(b, a, {
								type: "offset",
								offset: a.offset
							}))),
					b
				...
				mouseOverSlice: function (a, b) {
					...
					c.toggleClass("hover"),
					d.isOuter && !_.isEmpty(d.onHoverEffect) && this.effectOnSlice(c, d, d.onHoverEffect, !c.hasClass("hover"));
				...
				drawArc: function (a, b, c, d, e) {
					...
					g = 1,
					h = e - d;
					return h > Math.PI && (f = 1, h >= this.svgArcMax && (f = 0, g = 0)),
		...
		joint.shapes.chart.MatrixView = joint.dia.ElementView.extend({
				...
				renderMarkup: function () {
					...
					for (var f, g, h, i, j, k = document.createDocumentFragment(), l = 0; l < a.length; l++)
						for (h = this.elGridLine.clone(), h.addClass("horizontal"), h.attr("d", "M 0 " + l * c + " " + b.width + " " + l * c), k.appendChild(h.node), f = a[l], g = 0; g < f.length; g++)
							0 === l && (h = this.elGridLine.clone(), h.addClass("vertical"), h.attr("d", "M " + g * d + " 0 " + g * d + " " + b.height), k.appendChild(h.node)), i = f[g], i && (j = this.elCell.clone(), j.attr(_.extend({
										x: g * d,
										y: l * c,
										width: d,
										height: c
				...
				renderLabels: function () {
					...
					for (var j = document.createDocumentFragment(), k = 0; k < e.length; k++)
						a = d.rows[k], b = this.elLabel.clone(), b.text(a.text), b.attr(_.extend({
								x:  - (d.padding || 5),
								y: k * h + h / 2,
								"text-anchor": "end",
					...
					for (var l, m, n = document.createDocumentFragment(), o = 0; o < f.length; o++)
						a = d.columns[o], b = this.elLabel.clone(), l = o * i + i / 2, m =  - (d.padding || 5), b.attr("x", l), b.text(a.text), b.attr(_.extend({
								y: m,
								"text-anchor": "start",
								"dominant-baseline": "central",
								"font-size": i,
		...
		joint.shapes.bpmn.PoolView = joint.dia.ElementView.extend({
				...
				renderSublanes: function (a, b, c, d, e) {
					...
					_.each(a, function (a, d) {
						...
						this.index++,
						a.sublanes && this.renderSublanes(a.sublanes, b + n, o, h, l)
					}, this)
				}
			}),
		...
		joint.dia.CommandManager = Backbone.Model.extend({
				...
				push: function (a) {
					this.redoStack = [],
					a.batch ? (this.lastCmdIndex = Math.max(this.lastCmdIndex, 0), this.trigger("batch", a)) : (this.undoStack.push(a), this.trigger("add", a))
				},
				addCommand: function (a, b, c, d) {
					if ((!d || !d.dry) && this.get("cmdNameRegex").test(a) && ("function" != typeof this.get("cmdBeforeAdd") || this.get("cmdBeforeAdd").apply(this, arguments))) {
						...
						if ("add" === a || "remove" === a)
							return e.action = a, e.data.id = b.id, e.data.type = b.attributes.type, e.data.attributes = _.merge({}, b.toJSON()), e.options = d || {},
						void this.push(e);
						var j = a.substr(this.PREFIX_LENGTH);
						e.batch && e.action || (e.action = a, e.data.previous[j] = _.clone(b.previous(j)), e.options = d || {}, f ? e.graphChange = !0 : (e.data.id = b.id, e.data.type = b.attributes.type)),
						e.data.next[j] = _.clone(b.get(j)),
						this.push(e)
					}
				},
				...
				storeBatchCommand: function () {
					if (this.batchCommand && this.batchLevel <= 0) {
						...
						a.length > 0 && (this.redoStack = [], this.undoStack.push(a), this.trigger("add", a)),
		...
		joint.dia.Graph.prototype.constructTree = function (a, b, c, d) {
			...
			return c || (c = b.makeElement(a), d.push(c)),
			_.each(e, function (a) {
		...
		joint.ui.PaperScroller = joint.mvc.View.extend({
				...
				init: function () {
					...
					this.options.autoResizePaper && (this.listenTo(a.model, "change add remove reset", this.adjustPaper), a.options.async && this.listenTo(a, "render:done", this.adjustPaper)),
				...
				delegateBackgroundEvents: function (a) {
					function b(a, b, c) {
						return c.indexOf(" ") === -1 && (a[c] = _.isFunction(b) ? b : this.options.paper[b]),
						a
					}
					function c(a, b) {
						this.delegate(b, {
				...
				zoom: function (a, b) {
					...
					var c,
					d,
					e = this.clientToLocalPoint(this.el.clientWidth / 2, this.el.clientHeight / 2),
					f = a,
					g = a;
				...
				transitionToPoint: function (a, b, c) {
					...
					this.$background.off(this.transitionEventName).on(this.transitionEventName, _.bind(function (a) {
				...
				transitionToRect: function (a, b) {
					...
					l = Math.max(d, l),
					this.transitionToPoint(h, _.defaults({
							scale: l
						}, b))
				},
				...
				getPadding: function () {
					...
					return _.isFunction(a) && (a = a.call(this)),
		...
		joint.ui.Selection = joint.mvc.View.extend({
				...
				init: function () {
					...
					if (a.comparator || (a.comparator = this.constructor.depthComparator, a.sort()), this.model = a, !this.options.paper)
				...
				removeHandle: function (a) {
					...
					return c && (_.each(c.events, function (b, c) {
							this.off("action:" + a + ":" + c)
						}, this), this.$(".handle." + a).remove(), this.handles.splice(b, 1)),
					this
				},
		...
		!function (a, b) {
			...
			d.prototype.startLinking = function (a, c, d) {
				...
				g.attr(this.options.linkAttributes),
				b.isBoolean(this.options.smoothLinks) && g.set("smooth", this.options.smoothLinks),
				this.options.graph.addCell(g, {
					validation: !1,
					halo: this.cid,
					async: !1
				}),
				this._linkView = this.options.paper.findViewByModel(g),
			...
			d.prototype.startForking = function (c, d, e) {
				...
				h.attr(f.linkAttributes),
				b.isBoolean(f.smoothLinks) && h.set("smooth", f.smoothLinks),
				this.centerElementAtCursor(g, d, e),
				f.graph.addCells([g, h], {
					halo: this.cid,
					async: !1
				}),
				this._cloneView = g.findView(f.paper),
				this._cloneView.pointerdown(c, d, e)
			},
			...
			d.prototype.stopForking = function (a, b, c) {
				this._cloneView.pointerup(a, b, c),
				this.stopBatch()
			},
			...
			a.ui.Halo = a.mvc.View.extend({
					...
					init: function () {
						...
						b.bindAll(this, "pointermove", "pointerup", "render", "update"),
						a.clearAll && this.constructor.clear(h),
						this.listenTo(i, "reset", this.remove),
						this.listenTo(f, "remove", this.remove),
						this.listenTo(h, "halo:create", this.remove),
						a.clearOnBlankPointerdown && this.listenTo(h, "blank:pointerdown", this.remove),
						...
						this.handles = [],
						b.each(a.handles, this.addHandle, this)
					},
					render: function () {
						var c = this.options;
						...
						return this.update(),
						this.$el.addClass("animate").appendTo(c.paper.el),
						this.setPieIcons(),
						this
					},
					...
					addHandles: function (a) {
						return b.each(a, this.addHandle, this),
						this
					},
					addHandle: function (a) {
						var c = this.getHandle(a.name);
						return c || (this.handles.push(a), b.each(a.events, function (c, d) {
							...
							}, this), this.$handles && this.renderHandle(a).appendTo(this.$handles)),
						this
					},
					...
					removeHandle: function (a) {
						...
						return d && (b.each(d.events, function (b, c) {
								this.off("action:" + a + ":" + c)
							}, this), this.$(".handle." + a).remove(), this.handles.splice(c, 1)),
						this
					},
					...
					toggleHandle: function (a, c) {
						...
						if (d) {
							var e = this.$(".handle." + a);
							b.isUndefined(c) && (c = !e.hasClass("selected")),
					...
					deselectAllHandles: function () {
						return b.chain(this.handles).pluck("name").each(this.deselectHandle, this).value(),
						this
					},
					...
					toggleState: function (a) {
						if (this.isRendered()) {
							...
							if (b.each(this.$pieToggles, function (a) {
								...
								this.trigger("state:close", a), c.removeClass("open");
							else {
		...
		!function (a, b) {
			a.ui.Toolbar = a.mvc.View.extend({
					...
					groupsWithItemsPairs: function () {
						...
						return b.each(this.tools, function (b) {
							...
							a[c].items.push(b),
							a[c].group = this.groups[c] || {}
						}, this),
						b.chain(a).pairs().sortBy(function (a) {
					...
					render: function () {
						...
						return b.each(a, function (a) {
							...
							!c && d.group.align && "right" === d.group.align && (c = !0, e.addClass("group-first")),
							e.appendTo(this.el)
						}, this),
						this
					},
					renderGroup: function (a, d) {
						...
						return this.groupViews.push(e),
						e.on("all", b.bind(function () {
								this.trigger.apply(this, arguments)
							}, this)),
						e.render(),
						this.widgets = this.widgets.concat(e.widgets),
						e.$el
					},
					onRemove: function () {
						b.invoke(this.groupViews, "off"),
						b.invoke(this.groupViews, "remove")
					}
				});
			var c = a.mvc.View.extend({
					...
					onRemove: function () {
						b.invoke(this.widgets, "off"),
						b.invoke(this.widgets, "remove")
					}
				})
		}
		(joint, _),
		function (a, b) {
			a.ui.Widget = a.mvc.View.extend({
					...
					constructor: function (b, c) {
						...
						a.mvc.View.prototype.constructor.call(this, b)
					},
					...
					create: function (c, d) {
						...
						if (!b.isFunction(a.ui.widgets[e]))
							throw new Error('Widget: unable to find widget: "' + e + '"');
						var f = new a.ui.widgets[e](c, d),
						g = f.validateReferences(d);
						if (g.length > 0)
							throw new Error('Widget: "' + e + '" missing dependency: ' + g.join(", "));
						return f.render(),
						f.updateAttrs(c.attrs),
						f.bindEvents(),
						f.$el.attr("data-type", e),
						c.name && f.$el.attr("data-name", c.name),
						f
					}
				}),
			a.ui.widgets = {
				checkbox: a.ui.Widget.extend({
					...
					render: function () {
						...
						this.$span = $("<span/>"),
						this.$el.append([b, this.$input, this.$span]),
						this
					},
					onChange: function (a) {
				...
				toggle: a.ui.Widget.extend({
					...
					render: function () {
						...
						return this.$el.append([b, e.append(d, c)]),
						this
					},
					onChange: function (a) {
						this.trigger("change", !!a.target.checked, a)
				...
				range: a.ui.Widget.extend({
					...
					render: function () {
						var a,
						b = this.options;
						return this.$output = $("<output/>").text(b.value),
						a = $("<span/>").addClass("units").text(b.unit),
						this.$input = $("<input/>", {
								type: "range",
								name: b.type,
								min: b.min,
				...
				selectBox: a.ui.Widget.extend({
					render: function () {
						...
						return this.selectBox = new a.ui.SelectBox(c),
				...
				inputText: a.ui.Widget.extend({
					...
					render: function () {
						var a = this.options;
						return this.$label = $("<label/>").text(a.label),
				...
				selectButtonGroup: a.ui.Widget.extend({
					render: function () {
						var c = b.omit(this.options, "type", "group", "index");
						return this.selectButtonGroup = new a.ui.SelectButtonGroup(c),
		...
		!function (a, b) {
			...
			a.ui.Stencil = a.mvc.View.extend({
					...
					setPaper: function (b) {
						var c = this.options;
						if (b instanceof a.dia.Paper)
							c.paperScroller = null, c.paper = b, c.graph = b.model;
						else {
							if (!("function" == typeof a.ui.PaperScroller && b instanceof a.ui.PaperScroller))
					...
					render: function () {
						...
						if (this.options.groups) {
							...
							this.graphs.__default__ = f,
							this.papers.__default__ = g
						}
						return this._graphDrag = new a.dia.Graph,
						this._paperDrag = new a.dia.Paper({
								el: this.$paperDrag,
								width: 1,
								height: 1,
					...
					startListening: function () {
						this.stopListening(),
						b.each(this.papers, b.bind(this.listenTo, this, b, "cell:pointerdown", this.onDragStart))
					},
					load: function (a, c) {
					...
					setPaperDragOffset: function (a, b) {
						...
						return this._paperDrag.$el.offset(f),
						f
					},
					setCloneLocalPosition: function (a, b) {
						...
						return c.x -= this._cloneBBox.width / 2,
						c.y -= this._cloneBBox.height / 2,
					...
					onDrag: function (b) {
						...
						if (c) {
							...
							h && (i ? h.snapWhileMoving(c, b, f.x, f.y) : h.hide())
						}
					},
					onDragEnd: function (b) {
						...
						if (c) {
							...
							j = this.drop(b, i);
							j ? this.onDropEnd(c) : this.onDropInvalid(b, i),
							this.options.paper.options.embeddingMode && d && d.finalizeEmbedding({
								model: i,
								paper: this.options.paper
							}),
					...
					onDropInvalid: function (c, d) {
						var e = this._clone;
						if (e) {
							c = a.util.normalizeEvent(c),
							d = d || this.options.dragEndClone(e),
							this.trigger("drop:invalid", c, d);
							var f = this.options.dropAnimation;
							if (f) {
								var g = b.isObject(f) ? f.duration : 150,
								h = b.isObject(f) ? f.easing : "swing";
								this._cloneView = null,
								this._paperDrag.$el.animate(this._paperDragInitialOffset, g, h, b.partial(this.onDropEnd, e))
							} else
								this.onDropEnd(e)
						}
					},
					...
					drop: function (a, b) {
						...
						if (this.insideValidArea(e)) {
							...
							h = b.getBBox();
							f.x += h.x + this._cellViewDeltaOrigin.x,
							f.y += h.y + this._cellViewDeltaOrigin.y;
					...
					filter: function (c, d) {
						...
						f = b.reduce(this.papers, function (f, g, h) {
								var i = g.model.get("cells").filter(function (f) {
										...
										return V(h.el).toggleClass("unmatched", !i),
										i
									}, this),
								j = !b.isEmpty(i),
								k = (new a.dia.Graph).resetCells(i);
								return this.trigger("filter", k, h, c),
								this.isLayoutEnabled() && this.layoutGroup(k, this.getGroup(h)),
								this.$groups[h] && this.$groups[h].toggleClass("unmatched", !j),
								g.fitToContent({
									gridWidth: 1,
									gridHeight: 1,
									padding: this.options.paperPadding || 10
		...
		!function (a) {
			...
			a.ui.Inspector = a.mvc.View.extend({
					...
					init: function () {
						...
						this.widgets = [],
						this.flatAttributes = a.util.flattenObject(this.options.inputs, "/", function (a) {
								return a.type
							}),
						this._when = {},
						this._bound = {};
					...
					getCellAttributeValue: function (b, c) {
						...
						if (c = c || this.flatAttributes[b], !c)
							return e;
					...
					resolveBindings: function (b) {
						...
						case "select":
							var c = b.options || [];
							_.isString(c) && (c = a.util.getByPath(this.getModel().attributes, c, "/") || []),
							_.isObject(c[0]) || (c = _.map(c, function (a) {
										return {
											value: a,
											content: a
										}
					...
					renderFieldContent: function (b, c, d) {
						var e;
						if (_.isFunction(this.options.renderFieldContent) && (e = this.options.renderFieldContent(b, c, d)))
							return $(e).attr({
								"data-attribute": c,
								"data-type": b.type,
								"data-custom-field": !0
						...
						case "select-box":
							...
							e = $("<div/>").append(i, f.el),
							b.previewMode ? (h = f.selection, f.on("options:mouseout close", function () {
									f.selection = h,
						...
						case "select-button-group":
							...
							e = $("<div/>").append(i, f.el),
							b.previewMode ? (h = f.selection, f.on("mouseout", function () {
									f.selection = h,
									this.processInput(f.$el, {
										previewCancel: !0,
										dry: !0
									...
									b.multi ? f.selection = _.uniq(f.selection.concat([a])) : f.selection = a,
									this.processInput(f.$el, {
										dry: !0
									})
								}, this), f.on("option:select", function (a, b) {
					...
					renderOwnFieldContent: function (a) {
						...
						case "number":
							...
							b = [i, $("<div/>").addClass("input-wrapper").append(c)];
							break;
						case "range":
						...
						case "content-editable":
							...
							c = $("<div/>").prop("contenteditable", !0).css("display", "inline-block").html(j).on("blur", this.onContentEditableBlur),
							b = [i, $("<div/>").addClass("input-wrapper").append(c)];
							break;
						case "select":
							...
							_.each(k, function (a) {
								...
								l(a.value) && b.attr("selected", "selected"),
								c.append(b)
							}),
							b = [i, c];
							break;
					...
					renderTemplate: function (b, c, d, e) {
						...
						if (f.append(h), a.util.setAttributesBySelector(f, c.attrs), "list" === c.type)
							_.each(g, function (a, b) {
								var e = this.renderListItem({
										index: b,
										options: c
									});
								this.renderTemplate(e, c.item, d + "/" + b),
								h.children(".list-items").append(e)
							}, this);
							...
							_.each(i, function (a) {
								...
								this.renderTemplate(b, a, d + "/" + a.path),
								h.children(".object-properties").append(b)
							}, this)
						}
					...
					updateDependants: function (a) {
						_.each(this._when[a], function (a) {
							...
							a.expression.otherwise && a.expression.otherwise.unset && this.options.live && (e ? d && this.updateCell(b, a.path) : (this.unsetProperty(a.path), this.renderTemplate(null, this.flatAttributes[a.path], a.path, {
										replace: !0
									}), this.trigger("render")))
						}, this)
					},
					...
					updateCell: function (b, c, d) {
						...
						_.each(f, function (b, c) {
							if (!b.closest(".field").hasClass("hidden")) {
								...
								switch (i) {
								case "list":
									f = this.findParentListByPath(c),
									f ? (d = c.substr(f.length + 1), a.util.setByPath(g[f], d, [], "/")) : g[c] = [];
									break;
								case "object":
									break;
								default:
									if (!this.validateInput(i, b[0], c))
										return;
									...
									if (f = this.findParentListByPath(c), f && g[f])
										return d = c.substr(f.length + 1), void a.util.setByPath(g[f], d, k, "/");
									h[c] = k
								}
							}
						}, this),
						_.each(h, function (a, b) {
							this.setProperty(b, a, d),
							this.updateBindings(b),
							this.updateDependants(b)
						}, this),
						_.each(g, function (a, b) {
					...
					getFieldValue: function (a, b) {
						...
						case "select-button-group":
							var e = d.data("view");
							if (!e)
								throw new Error("ui.Inspector: can not read value of removed " + b);
					...
					pointerdown: function (a) {
						this.startBatchCommand(),
						this._$activeField = $(a.target).closest(".field").addClass("is-in-action"),
					...
					create: function (a, b) {
						...
						d = this.instance;
						return d && d.options.cell === c || (d && d.el.parentNode && (b.storeGroupsState && d.storeGroupsState(), d.updateCell(), d.remove()), d = new this(b).render(), this.instance = d, $(a).html(d.el), b.restoreGroupsState && d.restoreGroupsState()),
						d
					},
					close: function () {
						var a = this.instance;
		...
		joint.ui.FreeTransform = joint.mvc.View.extend({
				...
				stopOp: function () {
					this._elementOp && ($(this._elementOp).removeClass("in-operation"), this._elementOp = null),
		...
		joint.ui.Tooltip = joint.mvc.View.extend({
				...
				init: function () {
					...
					this.options.rootTarget ? (this.$rootTarget = $(this.options.rootTarget), _.each(a, function (a) {
							switch (a) {
							case "click":
				...
				bindHideActions: function (a) {
					...
					_.each(this.options.trigger.split(" "), function (a) {
						var e = {
				...
				normalizePosition: function (a) {
					...
					!a.position && b && (a.left && (a.position = "left"), a.right && (a.position = "right"), a.top && (a.position = "top"), a.bottom && (a.position = "bottom")),
					...
					i = {
						left: function (f) {
							...
							if (f) {
								...
								if (j > h && j < c.width + g && (i.width = j), j < h)
									return e.position = "right", this.right(!1)
							}
							return i
						},
						right: function (f) {
							...
							if (f) {
								var j = a.x - g - d.x;
								if (j > h && j < c.width + g && (i.width = j, i.x = d.x), j < h)
									return e.position = "left", this.left(!1)
							}
							return i
						},
						top: function (f) {
							...
							if (f) {
								...
								if (i < c.height)
									return e.position = "bottom", this.bottom(!1)
							}
							return h
						},
						bottom: function (f) {
							...
							if (f) {
								var i = a.y - g - d.y;
								if (i < c.height)
									return e.position = "top", this.top(!1)
							}
							return h
						}
					};
					...
					if (b.ui && !b.snapped && b.direction && b.trueDirection) {
						...
						if (c && c.model.isElement()) {
							...
							if (o.indexOf("right") !== -1 ? m.vertical = h.x : m.vertical = f.x, o.indexOf("bottom") !== -1 ? m.horizontal = h.y : m.horizontal = f.y, _.find(this.options.paper.model.getElements(), function (b) {
								...
								u = !(i % 90);
								if (u)
									90 === i || 270 === i ? (s = r, t = q) : (s = q, t = r);
								else {
									var v;
									v = i >= 0 && i < 90 ? 1 : i >= 90 && i < 180 ? 4 : i >= 180 && i < 270 ? 3 : 2,
									l && k && (r > q ? (r = 0, l = null) : (q = 0, k = null));
									var w = g.toRad(i % 90);
				...
				snapWhileMoving: function (a, b, c, d) {
					if (this.canElementMove(a)) {
						...
						if (_.find(this.options.paper.model.getElements(), function (a) {
								...
								d = b.origin(),
								f = b.corner();
								return _.isNull(o) && (Math.abs(c.x - j.x) < n ? (o = c.x, q = .5) : Math.abs(d.x - l.x) < n ? o = d.x : Math.abs(d.x - m.x) < n ? (o = d.x, q = 1) : Math.abs(f.x - m.x) < n ? (o = f.x, q = 1) : Math.abs(f.x - l.x) < n && (o = f.x)),
								_.isNull(p) && (Math.abs(c.y - j.y) < n ? (p = c.y, r = .5) : Math.abs(d.y - l.y) < n ? p = d.y : Math.abs(d.y - m.y) < n ? (p = d.y, r = 1) : Math.abs(f.y - m.y) < n ? (p = f.y, r = 1) : Math.abs(f.y - l.y) < n && (p = f.y)),
		...
		joint.ui.TextEditor = joint.mvc.View.extend({
				...
				onKeydown: function (a) {
					...
					this.hasSelection() && (this.deselect(), this.restoreTextAreaSelectionDirection()),
				...
				onInput: function (a) {
					if (this.textContentHasChanged()) {
						...
						if (this.options.annotateUrls && "insert" === e) {
							...
							/\s/.test(h) && (f = this.annotateURLBeforeCaret(c.start), f && (g = this.shiftAnnotations(g, d.end, b)))
						}
				...
				select: function (a, b) {
					...
					_.isNumber(this.selection.start) && _.isNumber(this.selection.end) && (this.selection.start === this.selection.end ? (this.clearSelection(), this.focus(), this.setCaret(this.selection.start)) : (this.hideCaret(), this.renderSelection(this.selection.start, this.selection.end)), this.trigger("select:change", this.selection.start, this.selection.end)),
					this
				},
				...
				selectTextInElementUsingRanges: function (a, b, c) {
					...
					for (var f, g, h, i, j, k, l = this.getTextNodesFromDomElement(a), m = 0, n = b + c; c > 0 && l.length > 0; )
						f = l.shift(), h = m, i = m + f.length, (h >= b && h < n || i > b && i <= n || b >= h && b < i || n > h && n <= i) && (j = Math.max(b - h, 0), k = Math.min(j + Math.min(c, f.length), i), g = document.createRange(), g.setStart(f, j), g.setEnd(f, k), d.addRange(g), c -= k - j), m += f.length
				},
				...
				setCaret: function (a, b) {
					_.isObject(a) && (b = a, a = void 0),
					b = b || {};
					var c = this.options.text,
					d = this.getNumberOfChars(),
					e = this.selection.start,
					f = this.textarea.value;
					"undefined" != typeof a && (a = Math.min(Math.max(a, 0), d), e = this.selection.start = this.selection.end = a),
		...
		!function (a, b, c) {
			"use strict";
			var d = function () {
				c.bindAll(this, "handleKey"),
				this.parser = new e,
				this.enable()
			};
			c.extend(d.prototype, b.Events),
			...
			e.prototype = {
				...
				composeEventObject: function (a) {
					...
					c = j.KEYDOWN,
					d = b[0];
					if (b.length > 1 && (d = b[1], c = b[0]), k.indexOf(c) === -1)
		...
		joint.ui.Lightbox = joint.ui.Dialog.extend({
				...
				init: function () {
					...
					joint.ui.Dialog.prototype.init.apply(this, arguments),
					this.options.image && (this.$image = $("<img/>").on("load", this.positionAndScale), this.options.content = this.$image),
		...
		joint.ui.SelectBox = joint.mvc.View.extend({
				...
				renderOptions: function () {
					...
					this.options.width && (a.width = this.options.width),
					this.optionsView = new this.constructor.OptionsView(a),
				...
				selectByValue: function (a, b) {
					for (var c = this.options.options || [], d = 0; d < c.length; d++) {
						...
						if (!_.isUndefined(e.value) && _.isEqual(e.value, a))
							return this.select(d, b)
					}
				},
				isOpen: function () {
		...
		joint.ui.SelectButtonGroup = joint.mvc.View.extend({
				...
				init: function () {
					_.bindAll(this, "onSelect", "pointerup"),
					this.$el.data("view", this);
				...
				selectByValue: function (a, b) {
					...
					for (var c = this.options.options || [], d = 0; d < c.length; d++) {
						var e = c[d];
						if (_.isUndefined(e.value) && _.contains(a, e.content))
							this.select(d, b);
		...
		joint.ui.Navigator = joint.mvc.View.extend({
				...
				init: function () {
					this.options.zoomOptions ? this.options.zoom = _.extend({}, this.options.zoom, this.options.zoomOptions) : this.options.zoom && (this.options.zoom = _.defaults({}, this.options.zoom, this.constructor.prototype.options.zoom)),
		...
		joint.ui.TreeLayoutView = joint.mvc.View.extend({
				...
				_finishDrag: function (a, b, c) {
					...
					this.candidate ? (_.each(a, _.partial(this.reconnectElement, _, this.candidate), this), this.candidate = null, this.model.layout({
							ui: !0
		...
		joint.layout.ForceDirected = Backbone.Model.extend({
				...
				step: function () {
					...
					v = this.links.length;
					for (f = 0; f < u - 1; f++)
						for (h = this.elements[f], q += h.x, r += h.y, g = f + 1; g < u; g++)
							i = this.elements[g], j = i.x - h.x, k = i.y - h.y, l = j * j + k * k, m = Math.sqrt(l), n = this.t * h.charge / l, o = n * j, p = n * k, h.fx -= o, h.fy -= p, i.fx += o, i.fy += p, this.energy += o * o + p * p;
					...
					y;
					for (f = 0; f < v; f++)
						w = this.links[f], h = w.source, i = w.target, j = i.x - h.x, k = i.y - h.y, l = j * j + k * k, m = Math.sqrt(l), x = this.t * w.strength * (m - w.distance) / m, o = x * j, p = x * k, y = h.weight / (h.weight + i.weight), h.x += o * (1 - y), h.y += p * (1 - y), i.x -= o * y, i.y -= p * y, this.energy += o * o + p * p;
					var z,
					A;
					for (f = 0; f < u; f++) {
						z = this.elements[f],
						...
						d && (A.x += (d.x - A.x) * this.t * c, A.y += (d.y - A.y) * this.t * c),
						A.x += z.fx,
						A.y += z.fy,
		...
		joint.layout.GridLayout = {
			layout: function (a, b) {
				...
				_.each(d, function (a, b) {
					...
					j && (c = (h - n.width) / 2, d = (i - n.height) / 2),
					c += l,
					d += m,
					a.set("position", {
						x: b % e * h + f + c,
		...
		!function (a, b, c, d) {
			...
			function f(a, b, d) {
				...
				this.nextSiblingGap = e.nextSiblingGap,
				this.prevSiblingGap = e.prevSiblingGap,
				this.gap = this.parentGap = e.parentGap,
				this.firstChildGap = e.firstChildGap,
				this.dx = 0,
				this.dy = 0,
				this.width = 0,
				this.height = 0,
			...
			var g = e.extend({
					...
					computeSize: function (a) {
						...
						this.height += c.sum(this.layoutAreas, function (a) {
			...
			var q = e.extend({
					...
					computeSize: function (a) {
						...
						this.width += c.sum(this.layoutAreas, function (a) {
			...
			c.extend(f.prototype, {
				...
				getRootVertices: function (a, b) {
					if (b = b || {}, a = a || this, 0 === a[this.deltaCoordinate] || !this.parentArea)
						return [];
					var d,
					e = this.parentArea.getInnerSize();
			...
			C = b.Model.extend({
					...
					layout: function (a) {
						...
						c.each(this.getGraphSources(a), c.partial(this.layoutTree, c, a), this),
					...
					_updateCells: function (a, b) {
						var d = a.root,
						e = a.link || null;
						e && (this.updatePosition && this.updatePosition(d, a.getRootPosition(), b), this.updateVertices && this.updateVertices(e, a.getRootVertices(), b)),
		...
		joint.dia.Paper.prototype.toSVG = function (a, b) {
			...
			b = b || {},
			this.trigger("beforeexport", b);
			var e = b.area ? b.area : V.transformRect(this.getContentBBox(), this.matrix().inverse()),
			f = this.svg.cloneNode(!0);
			f.removeAttribute("style"),
			b.preserveDimensions && V(f).attr({
				width: e.width,
				height: e.height
			}),
			V(f).findOne(".joint-viewport").removeAttr("transform"),
			V(f).attr("viewBox", e.x + " " + e.y + " " + e.width + " " + e.height);
			for (var g = document.styleSheets.length, h = [], i = g - 1; i >= 0; i--)
				h[i] = document.styleSheets[i], document.styleSheets[i].disabled = !0;
			var j = {};
			...
			for (var k = 0; k < g; k++)
				document.styleSheets[k].disabled = !1;
			var l = {};
			$(this.svg).find("*").each(function (a) {
				var b = window.getComputedStyle(this, null),
				c = j[a],
		...
		function stackBlurCanvasRGBA(a, b, c, d, e, f) {
			if (!(isNaN(f) || f < 1)) {
				...
				for (l = 0; l < e; l++) {
					...
					for (m = 1; m < M; m++)
						n = p + ((K < m ? K : m) << 2), r += (P.r = D = I[n]) * (H = M - m), s += (P.g = E = I[n + 1]) * H, t += (P.b = F = I[n + 2]) * H, u += (P.a = G = I[n + 3]) * H, z += D, A += E, B += F, C += G, P = P.next;
					for (R = O, S = Q, k = 0; k < d; k++)
				...
				for (k = 0; k < d; k++) {
					for (A = B = C = z = s = t = u = r = 0, p = k << 2, v = M * (D = I[p]), w = M * (E = I[p + 1]), x = M * (F = I[p + 2]), y = M * (G = I[p + 3]), r += N * D, s += N * E, t += N * F, u += N * G, P = O, m = 0; m < M; m++)
						P.r = D, P.g = E, P.b = F, P.a = G, P = P.next;
					for (o = d, m = 1; m <= f; m++)
						p = o + k << 2, r += (P.r = D = I[p]) * (H = M - m), s += (P.g = E = I[p + 1]) * H, t += (P.b = F = I[p + 2]) * H, u += (P.a = G = I[p + 3]) * H, z += D, A += E, B += F, C += G, P = P.next, m < L && (o += d);
					for (p = k, R = O, S = Q, l = 0; l < e; l++)
		...
		function stackBlurCanvasRGB(a, b, c, d, e, f) {
			if (!(isNaN(f) || f < 1)) {
				...
				Q = shg_table[f];
				for (l = 0; l < e; l++) {
					for (x = y = z = r = s = t = 0, u = I * (A = E[p]), v = I * (B = E[p + 1]), w = I * (C = E[p + 2]), r += J * A, s += J * B, t += J * C, L = K, m = 0; m < I; m++)
						L.r = A, L.g = B, L.b = C, L = L.next;
					for (m = 1; m < I; m++)
						n = p + ((G < m ? G : m) << 2), r += (L.r = A = E[n]) * (D = I - m), s += (L.g = B = E[n + 1]) * D, t += (L.b = C = E[n + 2]) * D, x += A, y += B, z += C, L = L.next;
					for (N = K, O = M, k = 0; k < d; k++)
				...
				for (k = 0; k < d; k++) {
					for (y = z = x = s = t = r = 0, p = k << 2, u = I * (A = E[p]), v = I * (B = E[p + 1]), w = I * (C = E[p + 2]), r += J * A, s += J * B, t += J * C, L = K, m = 0; m < I; m++)
						L.r = A, L.g = B, L.b = C, L = L.next;
					for (o = d, m = 1; m <= f; m++)
						p = o + k << 2, r += (L.r = A = E[p]) * (D = I - m), s += (L.g = B = E[p + 1]) * D, t += (L.b = C = E[p + 2]) * D, x += A, y += B, z += C, L = L.next, m < H && (o += d);
					for (p = k, N = K, O = M, l = 0; l < e; l++)
		...
		!function () {
			function a() {
				...
				a.ajax = function (a) {
					...
					b ? (b.open("GET", a, !1), b.send(null), b.responseText) : null
				},
				...
				a.BoundingBox = function (a, b, c, d) {
					...
					this.addPoint = function (a, b) {
						null != a && ((isNaN(this.x1) || isNaN(this.x2)) && (this.x1 = a, this.x2 = a), a < this.x1 && (this.x1 = a), a > this.x2 && (this.x2 = a)),
						null != b && ((isNaN(this.y1) || isNaN(this.y2)) && (this.y1 = b, this.y2 = b), b < this.y1 && (this.y1 = b), b > this.y2 && (this.y2 = b))
					},
				...
				a.AspectRatio = function (b, c, d, e, f, g, h, i, j, k) {
					...
					j.hasValue() && k.hasValue() ? b.translate(-p * j.toPixels("x"), -p * k.toPixels("y")) : (l.match(/^xMid/) && ("meet" == m && p == o || "slice" == m && q == o) && b.translate(d / 2 - e / 2, 0), l.match(/YMid$/) && ("meet" == m && p == n || "slice" == m && q == n) && b.translate(0, f / 2 - g / 2), l.match(/^xMax/) && ("meet" == m && p == o || "slice" == m && q == o) && b.translate(d - e, 0), l.match(/YMax$/) && ("meet" == m && p == n || "slice" == m && q == n) && b.translate(0, f - g)),
				...
				a.Element.ElementBase = function (b) {
					if (this.attributes = {}, this.styles = {}, this.children = [], this.attribute = function (b, c) {
						...
						return 1 == c && (d = new a.Property(b, ""), this.styles[b] = d),
						d || a.EmptyProperty
				...
				a.Element.svg = function (b) {
					...
					this.setContext = function (b) {
						...
						if (this.attribute("width").hasValue() || (this.attribute("width", !0).value = "100%"), this.attribute("height").hasValue() || (this.attribute("height", !0).value = "100%"), "undefined" == typeof this.root) {
							...
							var e = 0,
							f = 0;
							this.attribute("refX").hasValue() && this.attribute("refY").hasValue() && (e = -this.attribute("refX").toPixels("x"), f = -this.attribute("refY").toPixels("y")),
							b.beginPath(),
							b.moveTo(e, f),
							b.lineTo(c, f),
							b.lineTo(c, d),
				...
				a.Element.rect = function (b) {
					...
					this.path = function (b) {
						...
						g = Math.min(g, e / 2),
						h = Math.min(h, f / 2),
						null != b && (b.beginPath(), b.moveTo(c + g, d), b.lineTo(c + e - g, d), b.quadraticCurveTo(c + e, d, c + e, d + h), b.lineTo(c + e, d + f - h), b.quadraticCurveTo(c + e, d + f, c + e - g, d + f), b.lineTo(c + g, d + f), b.quadraticCurveTo(c, d + f, c, d + f - h), b.lineTo(c, d + h), b.quadraticCurveTo(c, d, c + g, d), b.closePath()),
				...
				a.Element.circle = function (b) {
					...
					this.path = function (b) {
						...
						return null != b && (b.beginPath(), b.arc(c, d, e, 0, 2 * Math.PI, !0), b.closePath()),
				...
				a.Element.ellipse = function (b) {
					...
					this.path = function (b) {
						...
						return null != b && (b.beginPath(), b.moveTo(f, g - e), b.bezierCurveTo(f + c * d, g - e, f + d, g - c * e, f + d, g), b.bezierCurveTo(f + d, g + c * e, f + c * d, g + e, f, g + e), b.bezierCurveTo(f - c * d, g + e, f - d, g + c * e, f - d, g), b.bezierCurveTo(f - d, g - c * e, f - c * d, g - e, f, g - e), b.closePath()),
				...
				a.Element.line = function (b) {
					...
					this.path = function (b) {
						...
						return null != b && (b.beginPath(), b.moveTo(c[0].x, c[0].y), b.lineTo(c[1].x, c[1].y)),
				...
				a.Element.polygon = function (b) {
					...
					this.path = function (a) {
						...
						return null != a && (a.lineTo(this.points[0].x, this.points[0].y), a.closePath()),
						b
					}
				},
				...
				a.Element.path = function (b) {
					...
					this.PathParser = new function (b) {
						...
						this.makeAbsolute = function (a) {
							return this.isRelativeCommand() && (a.x += this.current.x, a.y += this.current.y),
							a
						},
					...
					this.update = function (a) {
						if (null == this.initialValue && (this.initialValue = this.getProperty().value, this.initialUnits = this.getProperty().getUnits()), this.duration > this.maxDuration) {
							if ("indefinite" != this.attribute("repeatCount").value && "indefinite" != this.attribute("repeatDur").value)
								return "remove" == this.attribute("fill").valueOrDefault("remove") && !this.removed && (this.removed = !0, this.getProperty().value = this.initialValue, !0);
							this.duration = 0
						}
				...
				a.Element.text = function (b) {
					...
					this.renderChild = function (a, b, c) {
						var d = b.children[c];
						d.attribute("x").hasValue() ? d.x = d.attribute("x").toPixels("x") + this.getAnchorDelta(a, b, c) : (this.attribute("dx").hasValue() && (this.x += this.attribute("dx").toPixels("x")), d.attribute("dx").hasValue() && (this.x += d.attribute("dx").toPixels("x")), d.x = this.x),
						this.x = d.x + d.measureText(a),
						d.attribute("y").hasValue() ? d.y = d.attribute("y").toPixels("y") : (this.attribute("dy").hasValue() && (this.y += this.attribute("dy").toPixels("y")), d.attribute("dy").hasValue() && (this.y += d.attribute("dy").toPixels("y")), d.y = this.y),
						this.y = d.y,
						d.render(a);
				...
				a.Element.TextElementBase = function (b) {
					...
					this.getGlyph = function (a, b, c) {
						...
						if (a.isArabic) {
							...
							"undefined" != typeof a.glyphs[d] && (e = a.glyphs[d][f], null == e && "glyph" == a.glyphs[d].type && (e = a.glyphs[d]))
						} else
							e = a.glyphs[d];
					...
					this.apply = function (b) {
						for (var c = 0; c < this.children.length; c++) {
							...
							if ("undefined" != typeof d.path) {
								var e = null;
								d.attribute("transform").hasValue() && (e = new a.Transform(d.attribute("transform").value), e.apply(b)),
								d.path(b),
								b.clip(),
								e && e.unapply(b)
							}
				...
				a.loadXmlDoc = function (b, c) {
					...
					g = function () {
						...
						1 != a.opts.ignoreDimensions && (e.style("width").hasValue() && (b.canvas.width = e.style("width").toPixels("x"), b.canvas.style.width = b.canvas.width + "px"), e.style("height").hasValue() && (b.canvas.height = e.style("height").toPixels("y"), b.canvas.style.height = b.canvas.height + "px"));
						...
						e.render(b),
						f && (f = !1, "function" == typeof a.opts.renderCallback && a.opts.renderCallback(c))
					},
					h = !0;
					a.ImagesLoaded() && (h = !1, g()),
		...
		function (a, b) {
			...
			function d(a) {
				var c = 1;
				if (!b.isUndefined(a) && (c = parseFloat(a), !b.isFinite(c) || 0 === c))
			...
			function f(b) {
				...
				return b.width && b.height && (c.left + c.right >= b.width && (c.left = c.right = 0), c.top + c.bottom >= b.height && (c.top = c.bottom = 0)),
				c
			}
			function h(a) {
			...
			a.dia.Paper.prototype.toDataURL = function (a, f) {
				...
				f = f || {};
				var g,
				i = V.transformRect(this.getContentBBox(), this.matrix().inverse()),
				j = c(i, f),
				...
				m.onload = function () {
					function c() {
						...
						j.height = l.height,
						i = j.getContext("2d"),
						i.fillStyle = f.backgroundColor || "white",
						i.fillRect(0, 0, l.width, l.height)
					}
					function d() {
						e = j.toDataURL(f.type, f.quality),
						a(e),
						j.svg && b.isFunction(j.svg.stop) && b.defer(j.svg.stop)
					}
					var e,
					i,
					j;
					c();
					try {
						i.drawImage(m, 0, 0, l.width, l.height),
						d()
					} catch (k) {
				...
				this.toSVG(function (a) {
					g = a = a.replace('width="100%"', 'width="' + l.width + '"').replace('height="100%"', 'height="' + l.height + '"'),
		...
		!function (a, b, c, d) {
			function e(b) {
				b = b || {},
				this.trigger("beforeprint", b),
				this.$printArea = a("<div/>").addClass("printarea"),
				b.size && this.$printArea.addClass("printarea-size-" + b.size);
			...
			d.dia.Paper.prototype.print = function (c) {
				...
				h = b.once(function () {
						g(),
						a(window).off("afterprint", h)
					});
				a(window).one("afterprint", h),
				b.delay(h, 200),
				d(),
				window.print()
			}
		...
		joint.com.Channel.prototype.onConnection = function (a) {
			if (this._clients.push(a), this.trigger("open", a), this._isClient)
		...
		joint.com.Channel.prototype.onClose = function (a) {
			...
			this._isClient && !this._closed && (this._reconnectTimeout && clearTimeout(this._reconnectTimeout), this._reconnectTimeout = setTimeout(this.connectClient.bind(this), this.options.reconnectInterval)),
		...
		joint.com.Channel.prototype.onMessage = function (a, b) {
			...
			e,
			f = b.data;
			this._isClient ? (d = this.sites[this.id], f = this.receive(d, this.id, f)) : (e = this.sites[f.channelId], f = this.receive(e, f.channelId, f), d = this.sites[this.id], f = this.receive(d, this.id, f)),
			...
			this._isClient || (b.op = f, this.messageQueue.push(b), this.broadcast(b)),
		...
		joint.alg.Dijkstra = function (a, b, c) {
			...
			for (var h, i, j, k, l = {}; !f.isEmpty(); )
				for (h = f.remove(), l[h] = !0, i = a[h] || [], j = 0; j < i.length; j++)
					g = i[j], l[g] || (k = d[h] + c(h, g), k < d[g] && (d[g] = k, e[g] = h, f.updatePriority(g, k)));
			return e
		};
		joint.alg = joint.alg || {},
		...
		joint.alg.PriorityQueue.prototype.remove = function () {
			...
			a.length > 0 && (a[0] = c, c.id && (this.index[c.id] = 0), this.bubbleDown(0)),
			b && b.value
		},
		...
		joint.alg.PriorityQueue.prototype.bubbleDown = function (a) {
			for (var b = this.data, c = b.length - 1; ; ) {
				...
				e = d + 1,
				f = a;
				if (d <= c && this.comparator(b[d].priority, b[f].priority) < 0 && (f = d), e <= c && this.comparator(b[e].priority, b[f].priority) < 0 && (f = e), f === a)
					break;
				var g = b[f];
				b[f] = b[a],
